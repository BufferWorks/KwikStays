    ...
    <section className="my-8">
      ...
      <div className="divide-y divide-gray-200 bg-white rounded-2xl border-2 border-gray-200 shadow-lg overflow-hidden">
        {faqs.map((f, idx) => (
          <div key={idx}>
            <button
              className="w-full flex items-center justify-between py-4 px-5 md:py-5 md:px-6 text-left text-gray-900 font-bold text-sm hover:bg-gray-50 transition focus:outline-none"
